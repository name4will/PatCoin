# Support for Output Descriptors in Patcoin Core

Since Patcoin Core v0.17, there is support for Output Descriptors. This is a
...
on Patcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Patcoin Core wallets, a convenience function `combo` is
