...
"""Verify that starting patcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start patcoin with -h for help text")
        ...
        self.log.info("Start patcoin with -version for version information")
        ...
        self.log.info("Start patcoind with -fakearg to make sure it does not start")
