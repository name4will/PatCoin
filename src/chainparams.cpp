...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.patcoin.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.patcointools.com");
        vSeeds.emplace_back("dnsseed.patcoinpool.org");
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.patcointools.com");
        vSeeds.emplace_back("seed-b.patcoin.loshan.co.uk");
