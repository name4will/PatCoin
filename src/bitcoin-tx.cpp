...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " patcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  patcoin-tx [options] <hex-tx> [commands]  Update hex-encoded patcoin transaction\n" +
            "or:     patcoin-tx [options] -create [commands]   Create hex-encoded patcoin transaction\n" +
            "\n";
