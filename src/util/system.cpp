...
const char * const BITCOIN_CONF_FILENAME = "patcoin.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Patcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Patcoin";
#else
    // Unix
    return pathRet / ".patcoin";
#endif
#endif
}
